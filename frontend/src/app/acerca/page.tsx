      ...
      <div className={styles.main}>
        <div className={styles.layout}>
          ...
          <div className={styles.content}>
            ...
            {/* Compromiso */}
            <section className={styles.section}>
              <h2 className={styles.sectionTitle}>Nuestro compromiso: informar con claridad</h2>
              <p className={styles.bodyText}>
            ...
            {/* Video placeholder */}
            <section className={styles.section}>
              <h2 className={styles.sectionTitle}>¿Querés ver cómo funciona por dentro?</h2>
              <p className={styles.bodyText}>
            ...
            {/* Buenas prácticas */}
            <section className={styles.section}>
              <h2 className={styles.sectionTitle}>Buenas prácticas al usar este portal</h2>
              <div className={styles.limitaciones}>
                <div className={styles.limitacion}>
                  <strong>Fuente oficial: el SIL.</strong> Nuestro portal refleja fielmente lo que
                  la Asamblea publica. Si un dato aún no aparece en el sistema oficial,
                  estará disponible acá en cuanto se registre.
                </div>
                <div className={styles.limitacion}>
                  <strong>Actualización periódica.</strong> Sincronizamos los datos regularmente.
                  Puede haber un breve desfase con el sitio oficial, que se resuelve en la siguiente actualización.
                </div>
                <div className={styles.limitacion}>
                  <strong>Portal informativo.</strong> Esta herramienta facilita la consulta de información
                  legislativa. Para asesoría legal o jurídica, recomendamos acudir a una fuente calificada.
                </div>
              </div>
            </section>
          </div>
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.sideCard}>
              <div className={styles.sideCardAccent} />
              <div className={styles.sideTitle}>Código fuente</div>
              <p className={styles.sideText}>
