        ...
        <div className={styles.main}>
          ...
          <div className={styles.cols}>
            ...
            <div className={`${styles.col} ${styles.contactCol}`}>
              ...
              <a
                href="mailto:contacto@la-asamblea-al-dia.org"
                className={styles.contactLink}
                aria-label={dict.footer.enviarCorreoAria}
                title="contacto@la-asamblea-al-dia.org"
              >
                <IconMail />
                <span className={styles.contactLabel}>contacto@la-asamblea-al-dia.org</span>
              </a>
            </div>
